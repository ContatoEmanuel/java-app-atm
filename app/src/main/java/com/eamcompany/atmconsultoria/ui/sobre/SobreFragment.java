package com.eamcompany.atmconsultoria.ui.sobre;
...
import com.eamcompany.atmconsultoria.R;
...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return new AboutPage(getActivity())
                ...
                .addWebsite("https://www.programadormirim.com.br/","Acesse nosso Site ")
                .addGroup("Redes Sociais")
                .addFacebook("emanuelarrudas", "Facebook")
                .addInstagram("emanuel.arrudas", "Instagram")
                .addYoutube("UC85WRl4hmqK_DVdZhaKRqiA", "Youtube")
                .addGitHub("ContatoEmanuel", "GitHub")
